...
This package redistributes third-party material under the licenses below.

## JetBrains Mono

`src/Surfshack.Screenshots.Testing/Filmstrip/Fonts/JetBrainsMono-Regular.ttf` is bundled and
embedded as a resource. It is used to draw the time labels in composed filmstrip images.
...
The full text of the SIL Open Font License 1.1 follows.
